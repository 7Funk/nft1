  ...
  return (
    <div className={styles.story}>
      ...
      <p className={styles.textStory}>
        ...
        <br />
        <br />
        Meta-Fluencer’s are creative, brave, and stubborn characters who will do
        their utmost to save humanity, guiding them towards making right
        decisions — failure could have a catastrophic effect on humanity in the
        Metaverse.
        <br />
        <br />
